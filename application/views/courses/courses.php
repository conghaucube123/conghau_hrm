...
<div class="list">
    ...
    <div class="search">
        <form class="form-horizontal form-label-left" role="form" action="" method="get">
            ...
            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-9" id="btn">
    ...
    <div class="table-container">
        ...
        <div class="add">
            <a href="add" class="btn btn-success" style="color:#ffffff;"><i class="fas fa-plus"></i> <?php echo lang('courses_1'); ?></a>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-success" style="color:#ffffff" href="<?php echo base_url('Courses/courses'); ?>"><i class="fas fa-check"></i> <?php echo lang('confirm') ?></a>
                </div>
            </div>
        </div>
    </div>
